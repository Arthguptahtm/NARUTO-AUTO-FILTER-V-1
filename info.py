...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002326716167').split()]
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '').split()]
AUTH_USERS = (auth_users + ADMINS) if auth_users else []
auth_grp = environ.get('AUTH_GROUP')
AUTH_GROUPS = [int(ch) for ch in auth_grp.split()] if auth_grp else None
support_chat_id = environ.get('-1001892811935')
...
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Naruto_Htm_files')
...
REQ_CHANNEL = environ.get("REQ_CHANNEL", -1001799535143)
REQ_CHANNEL = int(REQ_CHANNEL) if REQ_CHANNEL and id_pattern.search(REQ_CHANNEL) else False
JOIN_REQS_DB = environ.get("JOIN_REQS_DB", DATABASE_URI)

#url links
SHORTLINK_URL = environ.get('SHORTLINK_URL', 'https://linkshortify.com')
SHORTLINK_API = environ.get('SHORTLINK_API', 'b5d694877529aba7db355d008372b8639165950e')
...
S_GROUP = environ.get('S_GROUP',"https://t.me/HTM_movie_request_group")
MAIN_CHANNEL = environ.get('MAIN_CHANNEL',"https://t.me/heresthemovies4")
#Must change this link to work redirect (FILE_FORWORD)
FILE_FORWARD = environ.get('FILE_FORWARD',"https://t.me/+7ExG-3nwGa5iNWNl")
MSG_ALRT = environ.get('MSG_ALRT', '𝑪𝑯𝑬𝑪𝑲 & 𝑻𝑹𝒀 𝑨𝑳𝑳 𝑴𝒀 𝑭𝑬𝑨𝑻𝑼𝑹𝑬𝑺')
FILE_CHANNEL = int(environ.get('FILE_CHANNEL', -1002368094934))
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', -1002359220462))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'HTM_movie_request_group')
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002368094934')).split()]
